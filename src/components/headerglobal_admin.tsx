...
import '../assets/css/headergloble_admin.css';
...
const Headerglobal_admin: React.FC = () => {
        ...
        <nav className="main-nav">
          <ul className="nav-list">
            <li className="nav-item">
              <NavLink to="/home_admin" className="nav-link">
                <FiHome className="nav-icon" />
                <span>Accueil</span>
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/transactions_admin" className="nav-link">
...
export default Headerglobal_admin;
